...
import mdevs.idle.cat.chat.adapters.MainAdapter;
import mdevs.idle.cat.chat.models.Message;
import mdevs.idle.cat.chat.utils.ProfanityFilter;
import mdevs.idle.cat.chat.utils.SCUtils;
...
public class CatChatActivity extends AppCompatActivity {
  ...
  private CatChatActivity mContext;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_catchat);
    Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
    setSupportActionBar(toolbar);

    mContext = CatChatActivity.this;
